      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        >
          <div className="max-w-xs">
            ...
            <Link
              href="/shop"
              className="inline-block bg-[#c9a96e] text-white text-sm px-5 py-2 rounded-full hover:opacity-90 transition"
            >
              SHOP NOW
            </Link>
          </div>
        ...
        >
          <div className="text-center mt-2">
            ...
            <Link
              href="/shop/rings"
              className="inline-block mt-4 bg-[#c9a96e] text-white text-sm px-5 py-2 rounded-full hover:opacity-90 transition"
            >
              SHOP RINGS
            </Link>
          </div>
        ...
        <div className="flex lg:flex-col gap-6">
          ...
          <div
            ...
            style={{
              backgroundImage: "url('/home/herosection/hero-right-bottom.png')", // replace
              backgroundSize: "cover",
              backgroundPosition: "center",
            }}
          >
            <div>
              ...
              <Link
                href="/shop/earrings"
                className="text-xs mt-2 inline-flex items-center gap-1 text-gray-700"
              >
                SHOP EARRINGS →
              </Link>
            </div>
